    ...
    <div className="fixed bottom-8 right-8 z-[500]">
            ...
            <div className="p-6 bg-brown/30 border-b border-bronze/20 flex justify-between items-center">
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="w-10 h-10 rounded-full bg-amber/20 border border-amber/40 flex items-center justify-center font-display font-semibold text-ivory">E</div>
                  <div className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-amber rounded-full border border-charcoal" />
                </div>
                <div>
                  <h3 className="text-sm font-display font-semibold text-ivory">EcoloBot</h3>
                  <p className="text-[9px] font-label text-amber/70">Atelier assistant</p>
                </div>
              </div>
              <button 
              ...
              {isLoading && (
                <div className="flex justify-start">
                  <div className="bg-white/5 px-4 py-2 rounded-2xl border border-white/10 flex gap-1">
                    <span className="w-1.5 h-1.5 bg-amber rounded-full animate-bounce [animation-delay:-0.3s]" />
                    <span className="w-1.5 h-1.5 bg-amber rounded-full animate-bounce [animation-delay:-0.15s]" />
                    <span className="w-1.5 h-1.5 bg-amber rounded-full animate-bounce" />
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="p-6 bg-black/50">
              <div className="flex gap-3 items-center">
                <input
                  ...
                  className="flex-1 bg-charcoal/50 border border-bronze/25 px-4 py-3 text-sm text-ivory font-body focus:outline-none focus:border-amber/50 transition-all"
                />
                <motion.button 
      ...
      <div className="relative flex items-center gap-4">
        ...
        <motion.button
          ...
          className="w-16 h-16 bg-charcoal border border-bronze/30 flex items-center justify-center relative overflow-hidden group shadow-warm"
        >
